...
const NewForm = () => {
    ...
    // 1. `category`:  La llamamos asi porque en este formulario, representa la categoría seleccionada.
    // 2. `SelectCategory`:  Lo nombramos asi para indicar claramente que es el componente para seleccionar la categoría.
